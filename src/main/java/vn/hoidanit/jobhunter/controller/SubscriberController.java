...
// return
// ResponseEntity.status(HttpStatus.CREATED).body(this.subscriberService.create(sub));
// }
...
// }
// return ResponseEntity.ok().body(this.subscriberService.update(subsDB,
// subsRequest));
// }

// @PostMapping("/subscribers/skills")
// @ApiMessage("Get subscriber's skill")
// public ResponseEntity<Subscriber> getSubscribersSkill() throws
// IdInvalidException {
